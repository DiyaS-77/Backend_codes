...
class TestApplication(QWidget):
    ...
    def __init__(self,interface=None,log_path=None):
        super().__init__()
        self.log=Logger("UI")
        #self.test_controller=Controller(self.log)
        #self.interface=self.test_controller.interface
    ...
    def test_application_clicked(self):
        ...
        self.test_application_window.setWindowTitle("Test Application ")
        ...
        main_grid_layout.addWidget(profiles_list_widget, 1, 0, 2, 2)
        ...
        #self.controller.interface=self.bluez_logger.bluez_interface

        #self.interface=self.controller.interface
        #self.controller.name = self.bluez_logger.name
        ##self.controller.name=details.get("Name","")
        #self.controller.bd_address = details.get("BD Address","")
        #self.controller.link_policy = details.get("Link Policy","")
        #self.controller.lmp_version = details.get("LMP Version","")
        #self.controller.link_mode = details.get("Link Mode","")
        #self.controller.hci_version = details.get("HCI Version","")
        #self.controller.manufacturer = details.get("Manufacturer","")
        ...
        #print(f'{controller_interface}')
        #self.controller.interface=self.interface
        #self.logs_layout.addWidget(self.dump_logs_text_browser)
        #INTERFACE=self.test_controller.get_controller_interface_details()
        #.interface_selected=INTERFACE.get("interface","")
        # Then start logging
        ...
        #self.bluez_logger.start_dump_logs(self.controller.interface)
        #self.bluez_logger.start_dump_logs(interface=self.interface, log_text_browser=self.hci_dump_log_text_browser)
