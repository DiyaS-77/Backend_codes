...
class TestApplication(QWidget):
    ...
    def test_application_clicked(self):
        if hasattr(self, 'test_application_window') and self.test_application_window.isVisible():
            self.test_application_window.raise_()
            return
        ...
        self.bg_label.setPixmap(QPixmap("/root/Desktop/BT_Automation/images/main_window_background.jpg"))
        ...
        def update_profiles_list_background():
            ...
            pixmap = QPixmap("/root/Desktop/BT_Automation/images/main_window_background.jpg")
        ...
        self.bluez_logger.get_controller_details(self.interface)
        ...
        def update_text_browser_background():
            ...
            scaled_pixmap = QPixmap("/root/Desktop/BT_Automation/images/main_window_background.jpg").scaled(
        ...
        main_grid_layout.addLayout(back_button_layout, 11, 0, 1, 1)  # Row 11, column 0
